...
def build_env(config:DictConfig):
    ...
    env = F110Env(map=map_manager.map_path, map_ext='.png', timestep=time_step ,num_beams=config.vehicle.num_beam, beam_fov=config.vehicle.beam_fov, num_agents=1, params=param)
